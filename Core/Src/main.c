...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, Blue_Led_Pin|Red_Led_Pin|Green_Led_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SW3_User_Pin SW2_User_Pin */
  GPIO_InitStruct.Pin = SW3_User_Pin|SW2_User_Pin;
